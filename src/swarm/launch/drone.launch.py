...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument('x', default_value='0', description='Spawn X position'))
    ld.add_action(DeclareLaunchArgument('y', default_value='0', description='Spawn Y position'))
